...
# Folder path
folder_path = r"C:\Users\rjpet\Desktop\Spotify Project\Updated Files\Genre Newtork\all_genre_collaboration_files"
...
# Save combined file
output_path = os.path.join(folder_path, "genre_network.csv")
